...
type HeartbeatRequest struct {
	...
	FreeSpaceBytes int64                  `protobuf:"varint,2,opt,name=free_space_bytes,json=freeSpaceBytes,proto3" json:"free_space_bytes,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type UploadPlanRequest struct {
	...
	RequiredCapacity int64                  `protobuf:"varint,2,opt,name=required_capacity,json=requiredCapacity,proto3" json:"required_capacity,omitempty"` // Required free space per node in bytes
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *UploadPlanRequest) GetRequiredCapacity() int64 {
	if x != nil {
...
const file_api_proto_v1_coordinator_proto_rawDesc = "" +
	...
	"\x10free_space_bytes\x18\x02 \x01(\x03R\x0efreeSpaceBytes\"7\n" +
	"\x11HeartbeatResponse\x12\"\n" +
	"\facknowledged\x18\x01 \x01(\bR\facknowledged\"a\n" +
	"\x11UploadPlanRequest\x12\x1f\n" +
	"\vshard_count\x18\x01 \x01(\x05R\n" +
	"shardCount\x12+\n" +
	"\x11required_capacity\x18\x02 \x01(\x03R\x10requiredCapacity\"\x9f\x01\n" +
